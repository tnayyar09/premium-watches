...
function validatePassword(password) {
    ...
    if (!/[a-zA-Z]/.test(password)) { errors.push("At least one letter required"); }
...
function loginUser(username, password) {
    ...
    return adminQuery("admin_users", {
        ...
        console.log("Hash Match:", user.password_hash === passwordHash);
...
function signupUser(data) {
    ...
    return adminQuery("admin_users", {
        ...
        return adminQuery("admin_users", {
            ...
            console.log("Signup - Creating user with hash:", hash);
...
function changePassword(userId, currentPassword, newPassword) {
    ...
    return adminQuery("admin_users", {
        ...
        return adminUpdate("admin_users", userId, {
            ...
            if (ok) { return { success: true, message: "Password changed successfully!" }; }
...
function resetPasswordWithToken(token, newPassword) {
    ...
    return adminQuery("password_reset_tokens", {
        ...
        if (new Date() > new Date(tokenData.expires_at)) {
            return { success: false, error: "Token expired. Generate a new one." };
        }
